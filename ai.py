...
def move(turn, board, player):
    ...
    while True:
        while True:
            row = input(f'{player}, you are {turn}. what row do you want (type 1, 2 or 3)')
            if row == '1' or row == '2' or row == '3':
                pass
            else:
                print('impossible')
                continue
            column = input('what column do you want(type 1, 2 or 3)')
